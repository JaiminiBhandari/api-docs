...
3. Select **Recipient Type: Individual or Bussiness**.
4. Select **Country**.
5. Enter personal details.
6. Enter Payment Method Information.
...
| Field Name                  | Sample Value    |
| --------------------------- | -------------- |
| Destination Bank / E-wallet | BDO Unibank    |
...
| Account Holder First Name | Matches recipient first name           | Accepted         |
| Account Holder Last Name  | Matches recipient last name            | Accepted         |
...
## Add a new recipient for United Arab Emirates (UAE)
