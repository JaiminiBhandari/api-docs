...
4. Enter the following details:
   ...
   - **Events to Subscribe**: Select the events you want to subscribe to (e.g. wallet.deposit.completed, otc.trade.created).
...
> Here is a sample video showing how to test the Webhook API:

<VideoPlayer src="video\webhook.mp4" width={800} />
