import{J as s,j as e}from"./entry.client-BmU5zPXR.js";const c="The Testing Accounts documentation provides standardized mock bank account details that enable developers to fully test payment workflows in the Sandbox environment without using real bank accounts or funds. This follows the same principle as PSP test cards (for example, 4242 4242 4242 4242) and ensures deterministic, repeatable test outcomes.",d=[{depth:1,value:"Bank Account Verification for BHD (Bahraini Dinar)",id:"bank-account-verification-for-bhd-bahraini-dinar",children:[{depth:2,value:"Overview",id:"overview"},{depth:2,value:"How to Use Testing Accounts",id:"how-to-use-testing-accounts"},{depth:2,value:"Supported Test Scenarios",id:"supported-test-scenarios"},{depth:2,value:"Accepted Testing Accounts for BHD",id:"accepted-testing-accounts-for-bhd"},{depth:2,value:"SWIFT/BIC and IBAN – Quick Reference",id:"swiftbic-and-iban--quick-reference",children:[{depth:3,value:"SWIFT / BIC Code",id:"swift--bic-code"},{depth:3,value:"IBAN (International Bank Account Number)",id:"iban-international-bank-account-number"},{depth:3,value:"Testing Account Table",id:"testing-account-table"}]},{depth:2,value:"Error Code Mapping",id:"error-code-mapping",children:[{depth:3,value:"Notes",id:"notes"}]},{depth:2,value:"Entity Coverage",id:"entity-coverage"},{depth:2,value:"Important Notes",id:"important-notes"},{depth:2,value:"Summary",id:"summary"}]}],o={lastModifiedTime:"2026-01-01T12:36:52.000Z"},a="pages\\bank-verification-bhd.md";function i(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"bank-account-verification-for-bhd-bahraini-dinar",children:"Bank Account Verification for BHD (Bahraini Dinar)"}),`
...
`,e.jsxs(n.p,{children:["Testing accounts support end-to-end validation of ",e.jsx(n.strong,{children:"deposits, withdrawals, payouts, and bank account validations"})," across all supported corridors and for both ",e.jsx(n.strong,{children:"individual"})," and ",e.jsx(n.strong,{children:"business"})," entities, specifically tailored for BHD transactions."]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"accepted-testing-accounts-for-bhd",children:"Accepted Testing Accounts for BHD"}),`
`,e.jsxs(n.p,{children:["The following testing accounts are ",e.jsx(n.strong,{children:"always accepted in Sandbox"})," for BHD-related transactions. These values can be reused across test runs and automated test suites."]}),`
...
`]}),`
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Entity Type"}),e.jsx(n.th,{children:"Currency"}),e.jsx(n.th,{children:"Country Code"}),e.jsx(n.th,{children:"Beneficiary Name"}),e.jsx(n.th,{children:"Bank Name"}),e.jsx(n.th,{children:"Account Number"}),e.jsx(n.th,{children:"SWIFT / BIC"}),e.jsx(n.th,{children:"IBAN"}),e.jsx(n.th,{children:"Expected Result"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Individual"}),e.jsx(n.td,{children:"BHD"}),e.jsx(n.td,{children:"BHR"}),e.jsx(n.td,{children:"Test Bahrain Individual"}),e.jsx(n.td,{children:"Bank of Bahrain & Kuwait"}),e.jsx(n.td,{children:"3000000001"}),e.jsx(n.td,{children:"TESTBHBM"}),e.jsx(n.td,{children:"BH00TEST000000000001"}),e.jsx(n.td,{children:"Success"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Business"}),e.jsx(n.td,{children:"BHD"}),e.jsx(n.td,{children:"BHR"}),e.jsx(n.td,{children:"Test Bahrain Business"}),e.jsx(n.td,{children:"Bank of Bahrain & Kuwait"}),e.jsx(n.td,{children:"3000000002"}),e.jsx(n.td,{children:"TESTBHBM"}),e.jsx(n.td,{children:"BH00TEST000000000002"}),e.jsx(n.td,{children:"Success"})]})]})]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.p,{children:"The Testing Accounts documentation enables safe, comprehensive testing of all payment flows using corridor-specific mock accounts. By providing predictable outcomes and stable error codes, developers can confidently validate integrations before moving to production, specifically for BHD transactions."})]})}function l(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{a as __filepath,l as default,c as excerpt,o as frontmatter,d as tableOfContents};
//# sourceMappingURL=bank-verification-bhd-Cy4TEo1u.js.map
