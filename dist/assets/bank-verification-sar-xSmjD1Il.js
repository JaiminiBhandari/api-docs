import{J as i,j as e}from"./entry.client-CLkf4Kjg.js";const c="The Testing Accounts documentation provides standardized mock bank account details that enable developers to fully test payment workflows in the Sandbox environment without using real bank accounts or funds. This follows the same principle as PSP test cards (for example, 4242 4242 4242 4242) and ensures deterministic, repeatable test outcomes.",d=[{depth:1,value:"Bank Account Verification for SAR (Saudi Riyal)",id:"bank-account-verification-for-sar-saudi-riyal",children:[{depth:2,value:"Overview",id:"overview"},{depth:2,value:"How to Use Testing Accounts",id:"how-to-use-testing-accounts"},{depth:2,value:"Supported Test Scenarios",id:"supported-test-scenarios"},{depth:2,value:"Accepted Testing Accounts for SAR",id:"accepted-testing-accounts-for-sar"},{depth:2,value:"SWIFT/BIC and IBAN – Quick Reference",id:"swiftbic-and-iban--quick-reference",children:[{depth:3,value:"SWIFT / BIC Code",id:"swift--bic-code"},{depth:3,value:"IBAN (International Bank Account Number)",id:"iban-international-bank-account-number"},{depth:3,value:"Testing Account Table",id:"testing-account-table"}]},{depth:2,value:"Error Code Mapping",id:"error-code-mapping",children:[{depth:3,value:"Notes",id:"notes"}]},{depth:2,value:"Entity Coverage",id:"entity-coverage"},{depth:2,value:"Important Notes",id:"important-notes"},{depth:2,value:"Summary",id:"summary"}]}],o={lastModifiedTime:"2026-01-01T12:36:52.000Z"},a="pages\\bank-verification-sar.md";function s(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"bank-account-verification-for-sar-saudi-riyal",children:"Bank Account Verification for SAR (Saudi Riyal)"}),`
...
`,e.jsxs(n.p,{children:["Testing accounts support end-to-end validation of ",e.jsx(n.strong,{children:"deposits, withdrawals, payouts, and bank account validations"})," across all supported corridors and for both ",e.jsx(n.strong,{children:"individual"})," and ",e.jsx(n.strong,{children:"business"})," entities, specifically tailored for SAR transactions."]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsxs(n.li,{children:["Go to Bank Accounts section from Sidebar and click the button ",e.jsx(n.strong,{children:"Add Bank Account"}),"."]}),`
`,e.jsxs(n.li,{children:["Choose the ",e.jsx(n.strong,{children:"currency"})," for the bank account as shown in the testing account table."]}),`
...
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"accepted-testing-accounts-for-sar",children:"Accepted Testing Accounts for SAR"}),`
...
`]}),`
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Entity Type"}),e.jsx(n.th,{children:"Currency"}),e.jsx(n.th,{children:"Country Code"}),e.jsx(n.th,{children:"Beneficiary Name"}),e.jsx(n.th,{children:"Bank Name"}),e.jsx(n.th,{children:"Account Number"}),e.jsx(n.th,{children:"SWIFT / BIC"}),e.jsx(n.th,{children:"IBAN"}),e.jsx(n.th,{children:"Expected Result"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Individual"}),e.jsx(n.td,{children:"SAR"}),e.jsx(n.td,{children:"SAU"}),e.jsx(n.td,{children:"Test KSA Individual"}),e.jsx(n.td,{children:"Al Rajhi Bank"}),e.jsx(n.td,{children:"2000000001"}),e.jsx(n.td,{children:"TESTSARI"}),e.jsx(n.td,{children:"SA00TEST000000000001"}),e.jsx(n.td,{children:"Success"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Business"}),e.jsx(n.td,{children:"SAR"}),e.jsx(n.td,{children:"SAU"}),e.jsx(n.td,{children:"Test KSA Business"}),e.jsx(n.td,{children:"Al Rajhi Bank"}),e.jsx(n.td,{children:"2000000002"}),e.jsx(n.td,{children:"TESTSARI"}),e.jsx(n.td,{children:"SA00TEST000000000002"}),e.jsx(n.td,{children:"Failure"})]})]})]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.p,{children:"The Testing Accounts documentation enables safe, comprehensive testing of all payment flows using corridor-specific mock accounts. By providing predictable outcomes and stable error codes, developers can confidently validate integrations before moving to production, specifically for SAR transactions."})]})}function l(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{a as __filepath,l as default,c as excerpt,o as frontmatter,d as tableOfContents};
//# sourceMappingURL=bank-verification-sar-xSmjD1Il.js.map
