import{J as s,j as e}from"./entry.client-C2DISYtT.js";const a="Welcome to ARP Digital.",l=[{depth:1,value:"ARP Digital",id:"arp-digital",children:[{depth:2,value:"Services",id:"services",children:[{depth:3,value:"Remittance",id:"remittance"},{depth:3,value:"Trading",id:"trading"},{depth:3,value:"Checkout",id:"checkout"}]},{depth:2,value:"API",id:"api",children:[{depth:3,value:"Authentication",id:"authentication"}]},{depth:2,value:"Signature Generation",id:"signature-generation"},{depth:2,value:"Servers",id:"servers"}]}],o={sidebar_label:"General Information",sidebar_icon:"heart-handshake",lastModifiedTime:"2026-01-12T11:06:36.000Z"},c="pages\\documentation.md";function i(t){const n={br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"arp-digital",children:"ARP Digital"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Sandbox Environment:"})," ",e.jsx(n.code,{inline:"true",children:"https://platform.stage.arpdigital.io/api/v1"})]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Production Environment:"})," ",e.jsx(n.code,{inline:"true",children:"https://platform.arpdigital.io/api/v1"})]}),`
...
//# sourceMappingURL=documentation-DeQqjD3r.js.map
